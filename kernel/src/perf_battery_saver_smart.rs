...
impl PerfBatterySaverSmart {
    ...
    pub fn log_status(&self) {
        ...
        println!("Low Power Mode: {}", self.low_power_mode);
        println!("Performance Level: {}", self.performance_level);
        println!("Whitelist Apps: {:?}", self.whitelist_apps);
        println!("Blacklist Apps: {:?}", self.blacklist_apps);
    }
}

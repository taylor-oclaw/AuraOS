...
impl ChineseIME {
    ...
    pub fn generate_suggestions(&mut self) {
        ...
        if !self.input_buffer.is_empty() {
            ...
            self.suggestions.push(format!("Suggestion 1: {}", input_str));
            self.suggestions.push(format!("Suggestion 2: {}", input_str));
            self.suggestions.push(format!("Suggestion 3: {}", input_str));
        }
    }

...
impl ProfileTravelPerDiemTrack {
    ...
    pub fn summary(&self) -> String {
        ...
        summary.push_str(&format!("Days Traveled: {}\n", self.days_traveled));
        summary.push_str(&format!("Daily Allowance: ${}\n", self.daily_allowance));
        summary.push_str(&format!("Total Expenses: ${}\n", self.total_expenses()));
        summary.push_str(&format!("Remaining Allowance: ${}\n", self.remaining_allowance()));
        summary
    }
}

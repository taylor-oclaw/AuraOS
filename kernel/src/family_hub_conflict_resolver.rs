...
impl FamilyHubConflictResolver {
    ...
    pub fn resolve_conflict(&self, location: &str) {
        match location {
            "kitchen" => println!("Resolved kitchen conflict by scheduling a family meeting."),
            "living_room" => println!("Resolved living room conflict by assigning chores evenly."),
            _ => println!("No known conflict resolution strategy for this location."),
        }
    }

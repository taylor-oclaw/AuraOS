...
impl WorkHours {
    ...
    pub fn get_summary(&self) -> String {
        let mut summary = format!("Name: {}, Target Hours: {}\n", self.name, self.target_hours);
        summary.push_str(&format!("Hours Worked: {}, Flex Hours: {}\n", self.hours_worked, self.flex_hours));
        summary.push_str(&format!("Overtime Allowed: {}", self.overtime_allowed));
        summary
    }
}

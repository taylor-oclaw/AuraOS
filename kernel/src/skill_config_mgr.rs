...
pub extern "C" fn rust_start() {
    ...
    println!("Skill count: {}", config_mgr.skill_count());
    println!("Skill level for AI-202: {}", config_mgr.get_skill_level("AI-202").unwrap_or("Unknown"));
    config_mgr.remove_skill("AI-101");
    println!("Skill count after removal: {}", config_mgr.skill_count());
}

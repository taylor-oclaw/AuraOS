...
pub extern "C" fn rust_start() {
    ...
    println!("Average response time: {}", tracker.average_response_time());
    println!("Max response time: {}", tracker.max_response_time());
    println!("Min response time: {}", tracker.min_response_time());
    println!("Total responses recorded: {}", tracker.total_responses());
}

...
pub extern "C" fn rust_start() {
    ...
    if result {
        println!("Violence detected!");
    } else {
        println!("No violence detected.");
    }
    detector.shutdown();
}

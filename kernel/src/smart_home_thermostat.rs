...
pub extern "C" fn rust_start() {
    ...
    println!("Current temperature: {}", thermostat.get_current_temperature());
    println!("Target temperature: {}", thermostat.get_target_temperature());
    println!("Is heating: {}", thermostat.is_heating());
    println!("Is cooling: {}", thermostat.is_cooling());
    println!("History: {:?}", thermostat.get_history());
}

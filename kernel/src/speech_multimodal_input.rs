...
pub extern "C" fn speech_multimodal_input_init() {
    // Initialization logic for the module
}

pub extern "C" fn speech_multimodal_input_exit() {
    // Cleanup logic for the module
}

pub struct SpeechMultimodalInput {
    data: Vec<u8>,
    metadata: String,
}

impl SpeechMultimodalInput {
    pub fn new(data: Vec<u8>, metadata: &str) -> Self {
        SpeechMultimodalInput {
            data,

...
impl LangInputIMEThai {
    ...
    pub fn generate_suggestions(&mut self) {
        ...
        if !self.input_buffer.is_empty() {
            ...
            self.suggestions.push(format!("{}{}", input_str, "ก"));
            self.suggestions.push(format!("{}{}", input_str, "ข"));
            self.suggestions.push(format!("{}{}", input_str, "ค"));
            self.suggestions.push(format!("{}{}", input_str, "ง"));
            self.suggestions.push(format!("{}{}", input_str, "จ"));
        }
    }
